...
commit `a12e441`：@tool(name="Write/Edit/Read"), eval_task.py tool counting backwards compat

### Phase 83 — MarkdownBackend recall 基准测试 ✅

commit `a6dd4b0`：recall top-1 ≥80% + real-world entity top-3 recall tests
