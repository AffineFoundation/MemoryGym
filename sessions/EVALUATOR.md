...
**目的**：
1. Kimi-K2.5 剩余模板（research/city/sport/movie s0）— 完成全 8 模板跨模型覆盖
2. Qwen3.5 hospital s1 — 最高分模板多 seed 方差测量
...
python -m memorygym.bench --model Qwen/Qwen3.5-397B-A17B-TEE --seed 1 --template hospital
```

**预期**：
- Kimi research/city/sport/movie：B1 数据已有（15-21%），Phase 99 后预期提升
- Qwen3.5 hospital s1：s0=45%，方差参考（s1 应在 30-50% 范围内）
