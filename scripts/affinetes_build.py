#!/usr/bin/env python3
"""Build MemoryGym Docker image using affinetes.
...
Examples:
    ...
    python scripts/affinetes_build.py --tag memorygym:v2
...
def main():
    parser = argparse.ArgumentParser(
        description="Build MemoryGym image with affinetes")
    parser.add_argument(
        "--tag", type=str, default="memorygym:latest",
        help="Image tag (default: memorygym:latest)")
    parser.add_argument(
    ...
    print(f"Building MemoryGym image: {args.tag}")
